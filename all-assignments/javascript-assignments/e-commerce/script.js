...
let categoryFilters = document.querySelectorAll("input[name='category']");
let priceRanges = document.querySelectorAll("input[name='price-range']");
let minimumPriceRange = document.getElementById("minimum-price-range");
  ...
  products.forEach((product) => {
    productListContainer.innerHTML += `
              ...
              <div class="flex flex-col gap-4 pb-3">
                <a
                  href="#"
                  class="d-inline-block max-w-[400px] bg-center bg-no-repeat aspect-square bg-cover rounded-xl"
                  style="
                ...
                <div class="mt-4">
                  ...
                  <h2 class="text-black title-font text-sm font-medium">
                    ${product.title}
                  </h2>
...
priceSubmitBtn.addEventListener("click", () => {
  let minPrice = minimumPriceRange.value;
  let maxPrice = maximumPriceRange.value;
...
categoryFilters.forEach((categoryFilter) => {
  categoryFilter.addEventListener("change", (e) => {
    ...
    if (selectedCategory == "jewelry") selectedCategory = "jewelery";
    let filteredProducts = productsList.filter((product) =>
